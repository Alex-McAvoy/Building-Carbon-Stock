...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    ...
    <div class="layui-tab-content">
            ...
            <div class="layui-tab-item layui-show">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <table id="editDieselFuelTable" class="layui-table">
                            <thead>
                            <tr>
                                <th>id</th>
                                <th>柴油消耗量</th>
                            ...
                            <!-- 动态生成表格 -->
                            <tbody id="editDieselFuelTableTbody">
                            </tbody>
                        </table>
                        <!-- 分页条 -->
                        <div class="tablePage">
                            <div id="editDieselFuelTablePage"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="layui-tab-item">
            <div class="layui-card">
                <div class="layui-card-body">
                    <table id="displayDieselFuelTable" class="layui-table">
                        <thead>
                        <tr>
                            <th>id</th>
                            <th>柴油转换能耗</th>
                        ...
                        <!-- 动态生成表格 -->
                        <tbody id="displayDieselFuelTableTbody">
                        </tbody>
                    </table>
                    <!-- 分页条 -->
                    <div class="tablePage">
                        <div id="displayDieselFuelTablePage"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="layui-card">
                <div class="layui-collapse" lay-accordion>
                    <div class="layui-colla-item">
                        <h2 class="layui-colla-title">柴油转换能耗</h2>
                        <div class="layui-colla-content layui-show">
                            <div id="display-chart1" class="visualization-chart"></div>
                        </div>
                    </div>
                    <div class="layui-colla-item">
                        <h2 class="layui-colla-title">柴油转换碳排放</h2>
